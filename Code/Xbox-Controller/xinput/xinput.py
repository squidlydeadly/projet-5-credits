...
class XInputJoystick(event.EventDispatcher):
    ...
    def dispatch_axis_events(self, state):
        ...
        for axis, type in list(axis_fields.items()):
            ...
            # ags, 2014-07-01
            if ((old_val != new_val and (new_val > 0.02000000000000000 or new_val < -0.02000000000000000) and abs(old_val - new_val) > 0.00000000800000000) or
               (axis == 'right_trigger' or axis == 'left_trigger') and new_val == 0 and abs(old_val - new_val) > 0.00000000800000000):
